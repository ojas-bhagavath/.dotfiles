...
[init](https://github.com/ojas-bhagavath/.dotfiles/tree/5391b10a05b0fd84dd25b547c2aaae899931e3d8/init) contains lua scripts that are pretty much self-explanatory. They are intended to be run on a fresh arch install to set everything up. You need to install lua on a fresh arch machine before running these.
