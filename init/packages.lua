return {
	aur = {
		...
		{ name = "gvfs", desc = "filesystem management utility for gnome-based file managers" },
		{ name = "gvfs-mtp", desc = "android mtp stuff for gnome-based file managers" },
		...
		{ name = "jellyfin-server", desc = "jellyfin server backend", system_service = "jellyfin.service" },
		{ name = "jellyfin-web", desc = "web client for jellyfin" },
		...
		{ name = "mime-tui", desc = "a tui utility to handle mime types" },
		...
		},
		{
			...
			root_config = {
				{ source = "snapper/root", target = "/etc/snapper/configs/root" },
				{ source = "snapper/snapper-conf", target = "/etc/conf.d/snapper" },
			},
		...
		{ name = "ttf-jetbrains-mono-nerd", desc = "jetbrains mono nerd font" },
		{ name = "ttf-kannada-font", desc = "Kannada font" },
		{ name = "ttf-nerd-fonts-symbols", desc = "nerd font symbols" },
	...
	flatpak = {
		...
		{ name = "org.localsend.localsend_app", desc = "send files/folders to devices on the same network" },
